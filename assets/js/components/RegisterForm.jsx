                    ...
                    <section className="c-accountForms c-accountForms__register u-clearfix">
                        <form onSubmit={this.props.onSubmit} className="form--border">
                            <div className="u-margin-bottom">
                                ...
                                <input className="input--border" type="text" id="name" onChange={this.props.handleNameChange} />
                            </div>
                            <div className="u-margin-bottom">
                            ...
                            <div className="u-margin-bottom">
                                ...
                                <input className="input--border" type="password" id="password" onChange={this.props.handlePasswordChange} />
                            </div>
